...
9. [ ] На скамейке у выделенного сотрудника показывать «галочку» для явного отличия выбранного состояния от hover.
10. [ ] Для выделенного сотрудника в timeline показывать только проекты, в которых он участвует, и только его самого в этих проектах (полная фильтрация связанных данных).
11. [ ] Добавить выделение целого отдела на скамейке с фильтрацией timeline по выбранному отделу.
