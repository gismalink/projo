...
- [ ] Финально подогнать визуал границ сетки и drag-хэндлеров в timeline (1d/1w/1m), чтобы границы и hit-area совпадали пиксель-в-пиксель с логикой расчета дат.
- [ ] Подключить производственный календарь через внешний API https://calendar.kuzyak.in/swagger (праздники/рабочие переносы) для более точной модели загрузки и планирования.
