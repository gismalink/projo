...
- [ ] Даты отпусков показывать с месяцами словами (локализованный формат), а не числовым месяцем.
- [ ] Кнопку выбора отдела в фильтрах заменить на иконку с выпадающим списком.
- [ ] Кнопку «Сбросить фильтры» заменить на иконку.
- [ ] Сократить тексты чипов/кнопок фильтров; полные названия показывать в tooltip.
- [ ] Фильтры отделов вынести в отдельную строку от остальных фильтров.

### Wave T2 (структура раздела и справочник отделов)
- [ ] Переименовать раздел «Сотрудники» в «Команда» (UI + i18n + навигация).
- [ ] Добавить кнопку «Список отделов».
- [ ] Реализовать popup управления отделами (просмотр/редактирование списка отделов).
