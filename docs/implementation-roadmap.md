...
- [ ] Создание роли унести из inline-формы в кнопку + popup.
- [ ] Добавить возможность редактировать роль (минимум: `name`, `shortName`, `description`, `level`, `colorHex`).
- [ ] Убрать явное сохранение по кнопке в списке ролей: сохранять изменения на лету (optimistic/autosave с защитой от частых запросов).
- [ ] Удалить из UI блок навыков как избыточный для текущего scope проекта.
