            ...
            {authMode === 'login' ? (
              <form onSubmit={onLoginSubmit} className="timeline-form">
                ...
                <label>
                  ...
                  />
                  <span
                    className={!loginEmailValue ? 'field-status pending' : isLoginEmailValid ? 'field-status success' : 'field-status error'}
                  >
                ...
                <label>
                  ...
                  />
                  <span
                    className={!loginPasswordValue ? 'field-status pending' : isLoginPasswordValid ? 'field-status success' : 'field-status error'}
                  >
                    {!loginPasswordValue
              ...
              <form onSubmit={onRegisterSubmit} className="timeline-form">
                ...
                <label>
                  ...
                  />
                  <span
                    className={!registerFullNameValue ? 'field-status pending' : isRegisterFullNameValid ? 'field-status success' : 'field-status error'}
                  >
                ...
                <label>
                  ...
                  />
                  <span
                    className={!registerEmailValue ? 'field-status pending' : isRegisterEmailValid ? 'field-status success' : 'field-status error'}
                  >
                    {!registerEmailValue ? t.uiStatusAwaitingEmail : isRegisterEmailValid ? t.uiStatusEmailValid : t.uiStatusEmailInvalid}
                  </span>
                </label>
                <label>
                  <span className="field-label required">{t.password}</span>
                  ...
                  />
                  <span
                    className={!registerPasswordValue ? 'field-status pending' : isRegisterPasswordValid ? 'field-status success' : 'field-status error'}
                  >
